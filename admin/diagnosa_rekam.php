...
$sql = mysqli_query($kon, "SELECT * FROM tb_rekam_medis WHERE id_rekam = '$id'");
...
<div class="panel-body" style="background-color: #f5f5f5; border-radius: 10px;">
     <div class="row">
          <div class="col-lg-12">
               <form method="POST" action="../config/updatediagnosa.php">

                    <div class="row">
                         <div class="col-md-12 marginku">
                              <a href="../img/rekammedis/<?= $data['foto']?>"><img src="../img/rekammedis/<?= $data['foto']?>" width="200px" alt=""></a>
                         </div>
                    </div>
                    <div class="row">
                         <div class="col-md-12 marginku">
